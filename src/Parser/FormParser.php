...
class FormParser 
{
    ...
    public function addField(Form $form, string $name, FieldAnnotation $annotation) {
        ...
        // If the field is an automatic APIType or collection of APIType, limits the depth to MAX_DEPTH
        if ((($field->getType() == CollectionType::class && $field->getOptions()['entry_type'] == APIType::class) || $field->getType() == APIType::class) && $form->getDepth() >= FormParser::MAX_DEPTH) return;
